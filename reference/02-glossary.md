...
- **詳細**: 体系的な解説は [03-frontier-platform.md](../core/03-frontier-platform.md) を参照。
...
- **Frontierの文脈**: エージェントの成果を継続的に評価し、人間のフィードバックをもとに
  ...
  表現に揺れがある。詳細は [03-frontier-platform.md](../core/03-frontier-platform.md) 3.2節(3)を参照。
...
- **Frontierの文脈**: "The OpenAI Deployment Company" 所属のFDE（Forward Deployed Engineer）が
  ...
  OpenAI側の導入支援プログラム。詳細は [03-frontier-platform.md](../core/03-frontier-platform.md) 3.4節を参照。

## Task Memory

- **Frontierの文脈**: 単一のエージェントタスクの実行中に記録される、中間推論・ツール呼び出し
  結果・人間のフィードバックなどの短期的なメモリ。詳細は [04-long-term-memory-deep-dive.md](../core/04-long-term-memory.md) を参照。

## Organizational Memory

- **Frontierの文脈**: タスクやエージェントをまたいで共有される知識ベース。ビジネスルールや
  過去の意思決定記録などを蓄積する、Crystal Intelligenceの「長期記憶」に最も近い概念。
  詳細は [04-long-term-memory-deep-dive.md](../core/04-long-term-memory.md) を参照。
...
- **Crystal Intelligence／Frontierの文脈**: 公式資料での言及は**一切なし**。
  ...
  詳細は [04-long-term-memory-deep-dive.md](../core/04-long-term-memory.md) 4.7節を参照。
...
[07-open-questions.md](03-open-questions.md) で整理します。
